...
function validateConfig(config) {
    ...
    if (config.persistence) {
        ...
        if (p.dbPath !== undefined && typeof p.dbPath !== 'string') {
            throw new QueueError_js_1.QueueError('QueueConfig.persistence.dbPath must be a string');
        }
        if (p.useNativeWAL !== undefined && typeof p.useNativeWAL !== 'boolean') {
            throw new QueueError_js_1.QueueError('QueueConfig.persistence.useNativeWAL must be a boolean');
        }
    }
