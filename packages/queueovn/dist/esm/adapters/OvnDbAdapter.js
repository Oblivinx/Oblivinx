...
export class OvnDbAdapter {
    ...
    async initialize() {
        let OvnClass;
        try {
            const mod = await import('oblivinx3x');
            ...
            throw new AdapterError('OvnDbAdapter requires "oblivinx3x" to be installed. Run: npm install oblivinx3x', err);
        }
