...
export declare class Collection<TSchema extends Document = Document> {
     ...
     * ```
     */
    enableVersioning(config?: VersioningConfig): Promise<void>;
    /**
     ...
     * ```
     */
    getVersion(docId: string, version: number): Promise<TSchema | null>;
    /**
     ...
     * ```
     */
    diffVersions(docId: string, v1: number, v2: number): Promise<VersionDiff>;
    /**
     ...
     * ```
     */
    rollbackToVersion(docId: string, version: number, author?: string): Promise<TSchema>;
    /**
     ...
     * ```
     */
    tagVersion(docId: string, version: number, tag: string): Promise<void>;
    /**
     ...
     * ```
     */
    restoreFromTag(docId: string, tag: string, author?: string): Promise<TSchema>;
}
