...
export type CollectionName = string & {
    readonly __brand: 'CollectionName';
};
/**
 ...
 */
export declare function asCollectionName(name: string): CollectionName;
/**
 ...
 */
export declare function asDocumentId(id: string): DocumentId;
export {};
