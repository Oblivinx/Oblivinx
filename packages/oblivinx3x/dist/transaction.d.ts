...
export declare class Transaction {
     ...
     * ```
     */
    find<T extends Document = Document>(collection: string, filter?: FilterQuery<T>): Promise<T[]>;
    /**
     ...
     * ```
     */
    findOne<T extends Document = Document>(collection: string, filter?: FilterQuery<T>): Promise<T | null>;
    /**
